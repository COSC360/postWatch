...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 21, 2023 at 07:55 PM
...
(7, 8, 8, 'Fantastic', '2023-03-20 13:37:26');
...
(14, 9, 'Iconic Watches in History', 'Watches are more than just tools for telling time. They are symbols of style, luxury, and sophistication. Throughout history, some watches have become iconic, transcending time and becoming cultural symbols. Here\'s a look at some of the most iconic watches in history.\r\n\r\nRolex Submariner\r\nThe Rolex Submariner is a watch that needs no introduction. It has been the go-to watch for divers, explorers, and adventurers since its launch in 1953. With its sleek design and durable construction, the Submariner has become an icon in the world of watches.\r\n\r\nOmega Speedmaster\r\nThe Omega Speedmaster is another watch that has become a cultural icon. Known as the \"Moonwatch,\" the Speedmaster was the first watch worn on the moon during the Apollo 11 mission in 1969. Its classic design and precision make it a favorite among collectors and enthusiasts.\r\n\r\nCartier Tank\r\nThe Cartier Tank is a watch that exudes elegance and sophistication. Its simple, rectangular design was inspired by the shape of a tank, and it has been worn by some of the most iconic figures in history, including Jackie Kennedy, Andy Warhol, and Princess Diana.\r\n\r\nPatek Philippe Nautilus\r\nThe Patek Philippe Nautilus is a watch that has gained a cult following since its launch in 1976. Its distinctive design, with its porthole-inspired case and integrated bracelet, has made it a symbol of luxury and status', 0x75706c6f6164732f77706f73742e6a7067, '2023-03-21 18:54:19');
...
(11, 'deletemetest', 'deleteme@test.com', '$2y$10$ox1IJ0FhOVqq8DrwphwOIedqPIQODkelBpEZE.c8JOJTyA7Wkweu.', NULL),
(12, 'deletemetest2', 'deleteme2@test.com', '$2y$10$DJeffcCZXgalYPJIei1wjeH1JW1EEypxuAxCzax8a4pcjkzKLgnoC', NULL);
